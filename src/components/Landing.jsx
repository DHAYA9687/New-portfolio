    ...
    >
      ...
      <div className="mt-10 w-64 h-64 lg:w-80 lg:h-80 md:w-56 md:h-56 sm:w-48 sm:h-48 order-1 lg:order-2">
        <img
          src={img1}
          alt="Profile"
          className="w-full h-full sm:m-4 rounded-full  border-4 hover:rounded-md hover:scale-110 hover:bg-customcolor object-cover  object-center border-6 border-customcolor shadow-lg transition-all duration-500 linear"
        />
      </div>
      {/* Left Side Content */}
